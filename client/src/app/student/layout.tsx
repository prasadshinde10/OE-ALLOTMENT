          ...
          <nav className="flex gap-4 sm:gap-8 overflow-x-auto">
            {user.year === 1 ? (
              <Link 
                ...
                className={`py-4 px-1 border-b-2 text-sm font-medium ${pathname === '/student/select-club' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
              >
                Select Clubs
              </Link>
            ) : (
            ...
            <Link 
              ...
              className={`py-4 px-1 border-b-2 text-sm font-medium ${pathname === '/student/profile' ? 'border-indigo-500 text-indigo-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
              My Profile
            </Link>
          </nav>
